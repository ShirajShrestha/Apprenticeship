...
router.post("/register", [
    ...
    (0, express_validator_1.check)("password", "Minimum 8 characters is required").isLength({ min: 8 }),
    ...
    try {
        ...
        yield user.save();
        const token = jsonwebtoken_1.default.sign({ userId: user.id }, process.env.JWT_SECURE_KEY, {
            expiresIn: "1d",
        });
